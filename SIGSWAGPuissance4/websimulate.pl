...
obtenirCoup(CouleurJCourant,4,Coup) :-
    iaMinimax(CouleurJCourant,Coup,3,1,1,0,0,1).
obtenirCoup(CouleurJCourant,5,Coup) :-
    iaMinimax(CouleurJCourant,Coup,4,1,0,0,0,1).
obtenirCoup(CouleurJCourant,6,Coup) :-
    iaMinimax(CouleurJCourant,Coup,4,1,1,0,0,1).
obtenirCoup(CouleurJCourant,7,Coup) :-
    iaMinimax(CouleurJCourant,Coup,5,1,0,0,0,1).
obtenirCoup(CouleurJCourant,8,Coup) :-
    iaMinimax(CouleurJCourant,Coup,5,1,1,0,0,1).
obtenirCoup(CouleurJCourant,9,Coup) :-
    iaMinimax(CouleurJCourant,Coup,3,1,1,0,1,0).
